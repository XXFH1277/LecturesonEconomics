...
- 最近课程：
  ...
  - [第六十七课：期权收益型 ETF 读表入门：Distribution Yield、SEC Yield、NAV 与总回报边界](./lessons/2026-07-25-lesson-67-option-income-etf-distribution-yield-nav-total-return.md)
  - [第六十六课：期权策略产品化入门：备兑、保护性 Put、Collar、Buffer ETF 与收益边界](./lessons/2026-07-25-lesson-66-option-strategy-products-covered-call-buffer-etf.md)
...
- 本次新增关键词：Structured Note、Equity-Linked Note、Issuer Credit Risk、Embedded Derivative、Reference Asset、Participation Rate、Barrier、Knock-In、Autocallable、Estimated Value、Secondary Market Liquidity、Autocallable Note、Observation Date、Contingent Coupon、Coupon Barrier、Call Value、Threshold Value、Principal at Risk、Underwriting Discount、No Listing、Worst-Performing、Memory Coupon。
...
- 学习目标：理解 worst-performing、basket note、correlation、single-stock event risk、knock-in、memory coupon、non-call period、decrement index、issuer call risk 和 scenario tree。
...
- 下节课开始前必须联网核验：至少一份最新多标的 auto-callable final pricing supplement、SEC/FINRA 复杂产品材料、相关指数官方页面、标的股票官方/交易所价格背景、Fed H.15 最新利率和发行人信用披露。
